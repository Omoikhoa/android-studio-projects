...
public class SelectStateFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonCancel.setOnClickListener(view12 -> mListener.cancelAddOrSelection());
    }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof SelectStateListener) {
            ...
            throw new RuntimeException(context.toString() + " must implement SelectStateListener");
        }
    }
