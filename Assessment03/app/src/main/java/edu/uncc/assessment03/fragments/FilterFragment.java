...
import edu.uncc.assessment03.adapters.CreditCategoryAdapter;
...
public class FilterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        CreditCategoryAdapter adapter = new CreditCategoryAdapter(getActivity(), Arrays.asList(creditCategories));
