...
import edu.uncc.assessment05.fragments.products.FavoritesFragment;
import edu.uncc.assessment05.fragments.products.PodcastsFragment;

public class MainActivity extends AppCompatActivity implements LoginFragment.LoginListener, SignUpFragment.SignUpListener, PodcastsFragment.PodcastsListener, FavoritesFragment.FavoritesListener {
    @Override
